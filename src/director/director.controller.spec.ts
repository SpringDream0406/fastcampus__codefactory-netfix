...
describe('DirectorController', () => {
  ...
  describe('findOne', () => {
    it('should call findOne method from DirecotrService with correct ID', () => {
      const result = { id: 1, name: 'codefactory' };
  ...
  describe('update', () => {
    it('should call update method from DirectortService with correct ID and DTO', () => {
      const updateDirectorDto = { name: 'Code Factory' };
      const result = { id: 1, name: 'Code Facotory' };
