...
describe('GenreService', () => {
  ...
  describe('findAll', () => {
    it('should return an array of genre', async () => {
  ...
  describe('update', () => {
    it('should update and return the genre if it exists', async () => {
      const updateGenreDto = { name: 'Update Fantasy' };
    ...
    it('should throw a NotFoundException if genre to update does not exist', async () => {
      ...
      await expect(
        service.update(1, { name: 'Update Fantasy' }),
      ).rejects.toThrow(NotFoundException);
    });
  });

  describe('remove', () => {
    it('should dlete a genre and return the id', async () => {
      const genre = { id: 1, name: 'Fantasy' };
