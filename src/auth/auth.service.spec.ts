...
describe('AuthService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: UserService, useValue: mockUserSerivce },
      ],
    }).compile();
  ...
  describe('tokenBlck', () => {
    ...
    describe('parseBasicToken', () => {
      it('should parse a valid Basic Token', () => {
        const rawToken = 'Basic dGVzdEBleGFtcGxlLmNvbToxMjMxMjM==';
        const result = authService.parseBasicToken(rawToken);
        const decoded = { email: 'test@example.com', password: '123123' };
  ...
  describe('register', () => {
    it('should register a new user', async () => {
      ...
      jest.spyOn(mockUserSerivce, 'create').mockResolvedValue(user);
  ...
  describe('authenticate', () => {
    it('should authenticate a user with correct credentials', async () => {
      ...
      const user = { email, password: 'hasedPassword' };
    ...
    it('should throw an error for not existring user', async () => {
    ...
    it('should throw an error for incorrect password', async () => {
      const user = { email: 'test@codefactory.ai', password: 'hasedPassword' };
